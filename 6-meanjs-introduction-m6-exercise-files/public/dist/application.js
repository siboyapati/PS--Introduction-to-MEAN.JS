...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'volunteer';
...
angular.module('articles').run(['Menus',
	function(Menus) {
		...
		//Menus.addSubMenuItem('topbar', 'articles', 'New Article', 'articles/create', null, false,['admin']);
	}
]);
		...
		$scope.signUp = function(need) {
			...
			$http.post('/email',{
				...
				if(data.success){
					...
					console.log('oops! there was an error with the sign-up form!');
				}
			});
		};
	}
